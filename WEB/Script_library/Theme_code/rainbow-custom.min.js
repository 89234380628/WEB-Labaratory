/* Rainbow v2.1.4 rainbowco.de | included languages: generic, html, javascript */ ! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.Rainbow = t() }(this, function() {
    "use strict";
    ...
    function l(e) {
        function t() { self.postMessage({ id: n.id, lang: n.lang, result: a }) }
        var n = e.data,
            r = new Prism(n.options),
            a = r.refract(n.code, n.lang);
        return n.isNode ? (t(), void self.close()) : void setTimeout(function() { t() }, 1e3 * n.options.delay)
    }

    function f() { return (R || null === j) && (j = c(l, Prism)), j }

    function d(e, t) {
        function n(a) { a.data.id === e.id && (t(a.data), r.removeEventListener("message", n)) }
        var r = f();
    ...
    var M, Prism = function Prism(e) {
                ...
                function f(t) {
                    ...
                    if (a) {
                        var i = r.matches[t],
                            ...
                            l = function(e, r, a) { b = u(o(m, t), e, a ? n(a, r) : r, b) };
            ...
            function m(e, t, n) { return v = t, n = n || g(t), d(a(e), n) }
            var v, p = {},
                h = {};
            this.refract = m
        },
    ...
    }), R || k || document.addEventListener("DOMContentLoaded", function(e) { x.defer || x.color(e) }, !1), k && (self.onmessage = l);
    var B = x;
    return B
});
